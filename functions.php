...
define('KOROMO_THEME_URL','https://wpkoi.com/koromo-wpkoi-wordpress-theme/','koromo');
define('KOROMO_WPKOI_AUTHOR_URL','https://wpkoi.com/','koromo');
define('KOROMO_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','koromo');
define('KOROMO_WORDPRESS_REVIEW','https://wordpress.org/support/theme/koromo/reviews/?filter=5','koromo');
define('KOROMO_DOCUMENTATION','https://wpkoi.com/docs/','koromo');
...
$myUpdateChecker = Puc_v4p3_Factory::buildUpdateChecker(
		// 'https://github.com/fresenius-dux/fmcna-com-parent',
		'https://github.com/bruce-kofi/diesalwerks',
		__FILE__,
		'diesalwerks'
);